...
import { emptyExercise, toDrafts } from '@/lib/drafts';
import { useDiscardSignal, useEditMode } from '@/lib/edit-mode';
import type { ExerciseDraft, ExerciseView } from '@/lib/types';
