...
export const ca: Dict = {
    ...
    'validate.title': "Completa això abans d'activar-la:",
    'validate.noWorkouts': 'La rutina no té dies.',
    'validate.emptyDay': '{day}: encara sense exercicis.',
    'validate.exerciseN': 'exercici {n}',
    'validate.noName': '{where}: posa-li un nom.',
    'validate.badSets': '{where}: les sèries no estan del tot definides.',
