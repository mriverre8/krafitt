...
export const ca: Dict = {
    ...
    'exercise.setMenu': 'Exercici {e}, accions de la sèrie {n}',
    'exercise.noTechnique': 'Tècnica sense especificar',
    'exercise.techniqueMenu': 'Exercici {e}, tècnica de la sèrie {n}',
    'exercise.setValue': 'Exercici {e}, quantitat de {label}',
    'exercise.removeTechniqueLabel': 'Exercici {e}, treure tècnica sèrie {n}',
