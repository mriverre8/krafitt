...
export const es: Dict = {
    ...
    'exercise.setMenu': 'Ejercicio {e}, acciones de la serie {n}',
    'exercise.noTechnique': 'Técnica sin especificar',
    'exercise.techniqueMenu': 'Ejercicio {e}, técnica de la serie {n}',
    'exercise.setValue': 'Ejercicio {e}, cantidad de {label}',
    'exercise.removeTechniqueLabel': 'Ejercicio {e}, quitar técnica serie {n}',
