...
export const es: Dict = {
    ...
    'validate.button': 'Validar rutina',
    'validate.ok': 'La rutina está completa. Ya puedes marcarla como activa.',
    'validate.title': 'Completa esto antes de activarla:',
    'validate.noWorkouts': 'La rutina no tiene días.',
    'validate.emptyDay': '{day}: sin ejercicios todavía.',
    'validate.exerciseN': 'ejercicio {n}',
    'validate.noName': '{where}: ponle un nombre.',
    'validate.badSets': '{where}: las series no están definidas del todo.',
