export const en = {
    ...
    'exercise.setMenu': 'Exercise {e}, set {n} actions',
    'exercise.noTechnique': 'Unspecified technique',
    'exercise.techniqueMenu': 'Exercise {e}, set {n} technique',
    'exercise.setValue': 'Exercise {e}, {label} amount',
    'exercise.removeTechniqueLabel': 'Exercise {e}, remove technique set {n}',
