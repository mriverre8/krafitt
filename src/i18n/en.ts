...
export const en = {
    ...
    'exercise.sets': 'Sets',
    'exercise.repMode': 'Reps type set {n}',
    'exercise.repMin': 'Min reps set {n}',
    'exercise.repMax': 'Max reps set {n}',
    'exercise.technique': 'Technique set {n}',
    'exercise.techniquePlaceholder': 'Technique (Straight sets)',
    'exercise.addSet': 'Add set',
    'exercise.removeSet': 'Remove set {n}',
