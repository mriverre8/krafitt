import { RoutineCard, type RoutineCardProps } from "@/components/RoutineCard";
...
describe("RoutineCard", () => {
  ...
  it("never reports more progress than the routine has", () => {
    render(<RoutineCard {...props} cursor={99} />);
  ...
  it("offers to activate a routine that is not active", async () => {
    ...
    render(<RoutineCard {...props} onSetActive={onSetActive} />);
