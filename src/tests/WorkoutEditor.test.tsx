...
describe("WorkoutEditor", () => {
  it("lists the exercises of the day", () => {
    render(<WorkoutEditor {...base} canEdit={false} />);
  ...
  it("offers the editing controls to an editor", () => {
    render(<WorkoutEditor {...base} canEdit />);
  ...
  it("confirms before deleting a day", async () => {
    ...
    render(<WorkoutEditor {...base} canEdit onDeleteWorkout={onDeleteWorkout} />);
  ...
  it("says so when the day is empty", () => {
    render(<WorkoutEditor {...base} workout={{ ...workout, exercises: [] }} canEdit={false} />);
